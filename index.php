...
<form method = "post" action = "<?php echo htmlspecialchars ($_SERVER["PHP_SELF"]) ?>">
    ...
    <select>
        ...
        <label for = "female"><small class = "default-style"> Female </small><input type = "radio" name = "gender" id = "female" value = "female" <?php if (isset ($gender) && $gender == 'female') $genderErr = '' ?> /> 
        <label for = "male"><small class = "default-style"> Male </samll><input type = "radio" name = "gender" id = "male" value = "male" <?php if (isset ($gender) && $gender == 'male') $genderErr = ''  ?> /> <br><br>
